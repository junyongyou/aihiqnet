...
for data_set in data_sets:
    for model_top in model_tops:
        ...
        for image_file, score in zip(test_image_files, test_scores):
            ...
            k += 1
            rf.write('{},{},{}'.format(image_file, score, iqa_score))
        rf.flush()
        rf.close()
...
#     result_files = [r'D:\Academic\Submission\TIP2020\Revision\deepIQA_live_patchwise.csv',
#                     r'D:\Academic\Submission\TIP2020\Revision\deepIQA_live_weighted.csv',
#                     r'D:\Academic\Submission\TIP2020\Revision\deepIQA_tid_patchwise.csv',
#                     r'D:\Academic\Submission\TIP2020\Revision\deepIQA_tid_weighted.csv']
#     for result_file in result_files:
#         with open(result_file, 'r+') as rf:
#             content = rf.readlines()
#             contents = content[0].strip().split(r'F:\SPAG_image_quality_dataset\512\TestImage_512_new')
#         scores = []
#         predictions = []

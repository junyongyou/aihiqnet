...
if __name__ == '__main__':
    ...
    args['result_folder'] = r'..\databases\experiments_fixed_shape'
    ...
    args['weights'] = r'..\databases\experiments_fixed_shape\resnet50_distribution_attention_fpn\21_0.8670_0.9262.h5'
